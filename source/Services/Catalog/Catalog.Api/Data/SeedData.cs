namespace Catalog.Api.Data
{
    ...
    {
        public async Task EnsurePopulated(WebApplication app)
        {
        ...
        private async Task SeedAsync(CatalogContext context, ILogger<SeedData> logger)
        {
            ...
            return Policy.Handle<SqlException>()
                .WaitAndRetryAsync(
                    ...
                    (exception, timeSpan, retry, context) =>
                    {
                        ...
                        $"[{prefix}] Exception {exception.GetType()} with message {exception.Message} on attempt {retry} of {retries}");
                    });
        }

        private IEnumerable<CatalogBrand> GetDefaultCatalogBrands()
        {
        ...
        private IEnumerable<CatalogType> GetDefaultCatalogTypes()
        {
        ...
        private IEnumerable<CatalogItem> GetDefaultCatalogItems()
        {
            return new List<CatalogItem>()
            {
                ...
                { 
                    ...
                    Price = 1200M, PictureFileName = "AdidasSneakers.jpg", 
                ...
                { 
                    ...
                    Price = 400M, PictureFileName = "PumaShorts.jpg", 
                ...
                { 
                    ...
                    Price = 800M, PictureFileName = "FilaBag.jpg", 
                ...
                { 
                    ...
                    Price = 1000M, PictureFileName = "NikeSneakers.jpg", 
                ...
                { 
                    ...
                    Price = 900M, PictureFileName = "NikeTShirt.jpg", 
                ...
                { 
                    ...
                    Price = 2200M, PictureFileName = "AdidasSweatpants.jpg", 
                ...
                { 
                    ...
                    Price = 2000M, PictureFileName = "AdidasSweatshirt.jpg", 
                ...
                { 
                    ...
                    Price = 3000M, PictureFileName = "NewBalanceSneakers.jpg", 
                ...
                { 
                    ...
                    Price = 500M, PictureFileName = "UAShorts.jpg", 
                ...
                { 
                    ...
                    Price = 2000M, PictureFileName = "NikeUnderwear.jpg", 
                ...
                { 
                    ...
                    Price = 1600M, PictureFileName = "ReebokSweatshirt.jpg", 
                ...
                { 
                    ...
                    Price = 4000M, PictureFileName = "ColumbiaJacket.jpg", 
                ...
                { 
                    ...
                    Price = 600M, PictureFileName = "FilaTShirt.jpg", 
                ...
                { 
                    ...
                    Price = 1400M, PictureFileName = "ReebokSweatpants.jpg", 
                    CatalogTypeId = 2, CatalogBrandId = 2, 
                ...
                { 
                    ...
                    Price = 2500M, PictureFileName = "PumaJacket.jpg", 
