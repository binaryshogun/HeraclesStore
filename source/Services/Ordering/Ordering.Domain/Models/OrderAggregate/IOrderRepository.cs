namespace Ordering.Domain.Models.OrderAggregate
{
    public interface IOrderRepository : IRepository<Order>
    {
        ...
        /// <summary>
        /// Asynchronously adds order to data source.
        /// </summary>
        /// <param name="order"><see cref="Order" /> instance that should be added to data source.</param>
        /// <returns><see cref="Task" /> that represents asynchronous operation and contains 
        /// <see cref="Order" /> instance that was added to data source.</returns>
        ...
        /// <param name="order"><see cref="Order" /> instance that should be updated.</param>
        /// <returns><see cref="Task" /> that represents asynchronous operation and contains 
        /// <see langword="true" /> if <paramref name="order" /> was successfully 
        /// updated, otherwise - <see langword="false" />.</returns>
